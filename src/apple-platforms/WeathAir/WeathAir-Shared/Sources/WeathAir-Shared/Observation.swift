...
class Observation : NSObject, NSCoding{
    ...
    var primaryPollutant : Bool!
    var recordSequence : Int!
    var reportingArea : ReportingArea!
	...
	init(fromJson json: JSON!){
        ...
        issuedDate = json["issued_date"].stringValue
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
		...
		issuedDate = aDecoder.decodeObject(forKey: "issued_date") as? String
		...
		validDate = aDecoder.decodeObject(forKey: "valid_date") as? String
	}
